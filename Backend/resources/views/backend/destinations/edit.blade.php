...
@section('title', 'Edit Destination - Admin TravelViet')
            ...
            <div class="row mb-6 gy-6">
                <div class="col-xxl">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.destinations.update', ['destination' => $destination->slug]) }}"
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            id="name" name="name" placeholder="Enter destination name"
                                    ...
                                    <div class="col-sm-10">
                                        <select id="status" class="form-select" name="status">
                                            ...
                                            <option value="inactive"
                                                {{ old('status', $destination->status) == 'inactive' ? 'selected' : '' }}>
                                                Inactive</option>
                                        </select>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div id="oldImageContainer" class="mb-2">
                                                    ...
                                                    @if (!empty($destination->image))
                                                        <img id="oldImage" src="{{ trim($destination->image) }}"
...
@section('scripts')
    <script>
        ...
        // Hủy ảnh mới đã chọn, quay lại ảnh cũ
