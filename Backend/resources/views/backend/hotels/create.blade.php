...
@section('content')
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold">Add New Hotel</h4>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ route('admin.hotels.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            @if (!empty($hotel->thumbnail))
                                <img src="{{ $hotel->thumbnail }}" width="150" class="mt-2 rounded">
                            @endif
                        </div>
                    ...
                    <div class="mt-4">
                        <button class="btn btn-primary px-4">Save Hotel</button>
                    </div>
                </form>
            </div>
        </div>
...
@section('scripts')
    <script>
        ...
        // Khi nhập name, nếu chưa sửa slug thì tự động cập nhật slug
        if (nameInput) {
