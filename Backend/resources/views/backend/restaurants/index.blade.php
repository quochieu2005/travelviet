                ...
                <tbody class="table-border-bottom-0">
                    @forelse ($restaurants as $key => $restaurant)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="{{ $restaurant->image ? $restaurant->image : asset('assets/img/avatars/1.png') }}"
                                        alt="{{ $restaurant->title }}" class="rounded" width="60" height="40"
                            ...
                            <td>
                                <span class="fw-medium text-primary">{{ number_format($restaurant->price, 0, ',', '.') }}
                                    ₫</span>
                            </td>

                            <td>
                                @if ($restaurant->oldprice)
                                    <del class="text-muted small">{{ number_format($restaurant->oldprice, 0, ',', '.') }}
                                        ₫</del>
                                @else
                                    <span class="text-muted">--</span>
                                @endif
                            ...
                            <td>
                                <form action="{{ route('admin.restaurants.toggle-status', $restaurant->slug) }}"
