...
@section('title', 'Create Category - Admin TravelViet')
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.categories.store') }}" method="POST"
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="description" class="form-control" name="description" placeholder="Enter category description"
                                            rows="4"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control" id="image" name="image"
                                            accept="image/*" />
                                        <div class="form-text mt-2">Upload category image (JPG, PNG, JPEG - max 2MB)
                                        </div>
                                        <!-- Image Preview -->
