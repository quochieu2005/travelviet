@extends('layouts.app')
@section('title', 'Create Tour - Admin TravelViet')
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h5 class="mb-0">Create New Tour</h5>
                            <a href="{{ route('admin.tours.index') }}" class="btn btn-secondary">Back to List</a>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.tours.store') }}" id="tourForm">
                                @csrf
                                <!-- Title & Slug -->
                                <div class="row mb-4">
                                    <div class="col-md-8">
                                        <label class="form-label" for="title">Tour Title <span
                                                class="text-danger">*</span></label>
                                        <div class="input-group input-group-merge">
                                            <span class="input-group-text"><i class="bx bx-map"></i></span>
                                            <input type="text" class="form-control @error('title') is-invalid @enderror"
                                                id="title" name="title" value="{{ old('title') }}"
                                                placeholder="Ví dụ: Tour Du Lịch Vịnh Hạ Long 3N2Đ" required>
                                        </div>
                                        @error('title')
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                                ...
                                                placeholder="tour-du-lich-vinh-ha-long">
                                        </div>
                                        <small class="form-text text-muted">Tự động sinh từ Title. Bạn có thể chỉnh
                                            tay.</small>
                                        @error('slug')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control @error('short_description') is-invalid @enderror" id="short_description"
                                        name="short_description" rows="2" placeholder="Mô tả ngắn gọn về tour...">{{ old('short_description') }}</textarea>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                        rows="6" placeholder="Chi tiết tour...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        <label class="form-label" for="price_adult">Giá Người Lớn (VNĐ) <span
                                                class="text-danger">*</span></label>
                                        <input type="text"
                                            class="form-control price-input @error('price_adult') is-invalid @enderror"
                                            id="price_adult" name="price_adult" value="{{ old('price_adult') }}"
                                        ...
                                        <div class="d-flex gap-3 mt-1">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="discount_type_adult"
                                                    id="discount_type_adult_percent" value="percent" checked>
                                                <label class="form-check-label" for="discount_type_adult_percent">Phần trăm
                                                    (%)</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="discount_type_adult"
                                                    id="discount_type_adult_fixed" value="fixed">
                                                <label class="form-check-label" for="discount_type_adult_fixed">Số tiền
                                                    (VNĐ)</label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-4" id="adult_percent_group">
                                        ...
                                        <input type="number" class="form-control" id="price_discount_percent"
                                            name="price_discount_percent" min="0" max="100" value="0"
                                            step="1">
                                    </div>
                                    <div class="col-md-4 d-none" id="adult_fixed_group">
                                        ...
                                        <input type="text" class="form-control price-input" id="discount_amount_adult"
                                            name="discount_amount_adult" value="0">
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            ...
                                            id="price_child" name="price_child" value="{{ old('price_child') }}"
                                            placeholder="0">
                                        @error('price_child')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                        ...
                                        <div class="d-flex gap-3 mt-1">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="discount_type_child"
                                                    id="discount_type_child_percent" value="percent" checked>
                                                <label class="form-check-label" for="discount_type_child_percent">Phần
                                                    trăm (%)</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="discount_type_child"
                                                    id="discount_type_child_fixed" value="fixed">
                                                <label class="form-check-label" for="discount_type_child_fixed">Số tiền
                                                    (VNĐ)</label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-4" id="child_percent_group">
                                        <label class="form-label" for="price_child_discount_percent">Giảm giá TE
                                            (%)</label>
                                        <input type="number" class="form-control" id="price_child_discount_percent"
                                            name="price_child_discount_percent" min="0" max="100"
                                            value="0" step="1">
                                    </div>
                                    <div class="col-md-4 d-none" id="child_fixed_group">
                                        ...
                                        <input type="text" class="form-control price-input" id="discount_amount_child"
                                            name="discount_amount_child" value="0">
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number"
                                            class="form-control @error('max_people') is-invalid @enderror" id="max_people"
                                            name="max_people" min="1" value="{{ old('max_people') }}">
                                        @error('max_people')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        <label class="form-label" for="destination_id">Điểm đến <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control @error('itinerary') is-invalid @enderror" id="itinerary" name="itinerary"
                                        rows="5" placeholder="Chi tiết lịch trình tour...">{{ old('itinerary') }}</textarea>
                                    @error('itinerary')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control" name="included_services[]" rows="4"
                                            placeholder="Khách sạn 4 sao&#10;Xe limousine&#10;Bữa sáng + trưa + tối&#10;HDV tiếng Việt">{{ old('included_services.0') }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control" name="excluded_services[]" rows="4"
                                            placeholder="Vé máy bay&#10;Chi phí cá nhân&#10;Tip hướng dẫn viên&#10;Đồ uống trong bữa ăn">{{ old('excluded_services.0') }}</textarea>
                                        <small class="text-muted">Mỗi dòng một dịch vụ</small>
                                    </div>
                                </div>
                                ...
                                <div class="text-end">
                                    <button type="submit" class="btn btn-primary me-2">Tạo Tour</button>
    ...
    <script>
        ...
        function bindPriceFormatting(el) {
            ...
            el.addEventListener('blur', () => {
                const v = getRawNumber(el.value);
                el.value = v > 0 ? formatNumber(v) : '';
            });
        ...
        // Khởi tạo lần đầu
        setTimeout(() => {
            recalcDiscount('price_adult', 'discount_type_adult', 'price_discount_percent', 'discount_amount_adult',
                'discount_price');
            recalcDiscount('price_child', 'discount_type_child', 'price_child_discount_percent',
                'discount_amount_child', 'discount_price_child');
        }, 100);

        // ==================== SUBMIT ====================
        document.getElementById('tourForm')?.addEventListener('submit', function() {

            // Làm sạch giá gốc (bỏ dấu chấm)
            ...
            // --- Người lớn ---
            const typeAdult = document.querySelector('input[name="discount_type_adult"]:checked')?.value ||
                'percent';
            ...
            // Không gửi field readonly discount_price_child (controller tự tính)
