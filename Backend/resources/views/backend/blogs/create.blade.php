            ...
            <form action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            @enderror
                            <small class="form-text text-muted">Slug sẽ tự động tạo từ title</small>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="read_time"
                                ...
                                value="{{ old('read_time', 5) }}" min="1" required>
                            @error('read_time')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="is_featured">
                                    Featured Post (Hiển thị nổi bật)
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div id="thumbnailPreviewContainer" class="mt-2" style="display: none;">
                                ...
                                <button type="button" id="removeThumbnail"
                                    class="btn btn-sm btn-danger mt-1">Remove</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-3">
                    <button type="submit" class="btn btn-primary">
                        <i class="icon-base bx bx-save me-1"></i> Publish Post
                    </button>
